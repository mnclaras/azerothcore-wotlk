...
class custom_item_teleporter : public ItemScript
{
public:
    ...
    bool OnUse(Player* player, Item* item, SpellCastTargets const& /*targets*/) override
    {
        ...
        {
            player->GetSession()->SendNotification(isSpanish ? "Error! Estas volando." : "Failure! You are flying.");
    ...
    void OnGossipSelect(Player* player, Item* item, uint32 /*sender*/, uint32 action) override
    {
        ...
        case 15: // Climbing circuits
            ...
            AddGossipItemFor(player, GOSSIP_ICON_TAXI, isSpanish ? "Circuito 5 (Imposible)" : "Circuit 5 (Impossible)", GOSSIP_SENDER_MAIN, 1004);
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, isSpanish ? "Inicio" : "Home Page", GOSSIP_SENDER_MAIN, 999);
            SendGossipMenuFor(player, DEFAULT_MESSAGE, item->GetGUID());
            break;
