...
class LearnSpellsOnLevelUp : public PlayerScript
{
  public:
    ...
    {
        if (sConfigMgr->GetBoolDefault("LearnSpells.LearnAllOnFirstLogin", true))
        {
  ...
  private:
    std::unordered_set<uint32> m_ignoreSpells = {
		...
		// FIRST AID
		10846,
		// DESTROZAR FELINO Y OSO
		33878, 33986, 33987, 48563, 48564, 33876, 33982, 33983, 48565, 48566,
		// Actitud Rabiosa Pasiva
		7381
    };
             ...
             {SPELLFAMILY_HUNTER,
              {
				  ...
				  AddSpell{.spellId = 6991}, // feed pet
				  AddSpell{.spellId = 883}, // call pet
				  AddSpell{.spellId = 2641}, // quit pet
              }},
         }},
        {12,
         {
        ...
        {20,
         {
			 ...
			 {SPELLFAMILY_WARLOCK,
              {
                  AddSpell{.spellId = 5784}, // Summon Felsteed
              }},	
			 {SPELLFAMILY_PALADIN,
              {
                  AddSpell{.spellId = 13819}, // Mount
              }},
         }},
        {24,
         {
             {SPELLFAMILY_HUNTER,
              {
				  ...
				  AddSpell{.spellId = 19885}, //  Track hidden
              }},
             {SPELLFAMILY_ROGUE,
              {
        ...
        {40,
         {
			 ...
			 {SPELLFAMILY_WARLOCK,
              {
                  AddSpell{.spellId = 23161}, // Dreadsteed
              }},
			 {SPELLFAMILY_PALADIN,
              {
                  AddSpell{.spellId = 23214}, // Mount
              }}, 
         }},
        {50,
         {
			 ...
			 {SPELLFAMILY_WARLOCK,
              {
                  AddSpell{.spellId = 1122}, //  Summon felsteed
              }},
         }},
		{57,
         {
			 {SPELLFAMILY_DEATHKNIGHT,
              {
				  AddSpell{.spellId = 54447}, // Rune of Spellbreaking
				  AddSpell{.spellId = 53342}, // Rune of Spellshattering
              }},
         }},
		{60,
         {
			 {SPELLFAMILY_DEATHKNIGHT,
              {
                  AddSpell{.spellId = 53331}, // Rune of Lichbane
              }},
			 {SPELLFAMILY_WARLOCK,
              {
                  AddSpell{.spellId = 18540}, //  Ritual of Fatality
              }},
         }},
		{61,
         {
			 {SPELLFAMILY_DEATHKNIGHT,
              {
                  AddSpell{.spellId = 3714},  // Path of Frost
              }},
         }},		
		{63,
         {
			 {SPELLFAMILY_DEATHKNIGHT,
              {
                  AddSpell{.spellId = 54446}, // Rune of Sworldbreaking
				  AddSpell{.spellId = 53323}, // Rune of Sworldshattering
              }},
         }},
        {66,
         {
        ...
        {70,
         {
			 ...
			 {SPELLFAMILY_DEATHKNIGHT,
              {
                  AddSpell{.spellId = 53344}, // Rune of the Fallen Crusader
              }},
         }},
		{72,
         {
			 {SPELLFAMILY_DEATHKNIGHT,
              {
				  AddSpell{.spellId = 70164}, // Rune of the Nerubian Caparace
				  AddSpell{.spellId = 62158}, // Rune of the Stoneskin Gargoyle
              }},
         }},
        {80,
         {
