...
export CONFIG="/home/root/server/etc/worldserver.conf"

# path of log files
# needed by restarter to store its logs
export LOGS_PATH="/home/root/server/logs";
